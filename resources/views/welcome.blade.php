            ...
            <div class="min-w-0 max-w-2xl flex-auto px-4 py-16 lg:max-w-none lg:pr-0 lg:pl-8 xl:px-16">
                ...
                <section class="mt-10 bg-transparent">
                                ...
                                <div class="mx-auto max-w-2xl">
                                    <div class="max-w-lg">
                                        ...
                                        <div class="mt-10 flex items-center gap-x-6">
                                            <a href="{{ route('documentation.personalization.soft') }}" wire:navigate class="text-sm font-semibold leading-6 text-gray-700 dark:text-gray-400">Learn more <span aria-hidden="true">→</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mt-8 flex justify-center">
                        <a href="{{ route('documentation.get-started') }}" wire:navigate class="text-2xl font-semibold text-gray-700 dark:text-pink-600">
