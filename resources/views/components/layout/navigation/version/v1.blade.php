<ul role="list" class="space-y-9">
    <li>
        ...
        <ul role="list" class="mt-4 space-y-2 dark:border-slate-800 lg:space-y-4 lg:mt-4 lg:border-slate-200">
            <li class="relative ml-4">
                <x-layout.navigation.link :href="route('documentation.v1.getting-started')" text="Get Started" />
            </li>
            <li class="relative ml-4">
    ...
    <li>
        ...
        <ul role="list" class="mt-4 space-y-2 dark:border-slate-800 lg:space-y-4 lg:mt-4 lg:border-slate-200">
            ...
            <li class="relative ml-4">
                ...
                <ul role="list" class="mt-4 space-y-2 dark:border-slate-800 lg:space-y-4 lg:mt-4 lg:border-slate-200">
                    <li class="relative ml-4">
                        <x-layout.navigation.link :href="route('documentation.v1.interaction.dialog')" text="Dialog" />
                    </li>
                    <li class="relative ml-4">
                        <x-layout.navigation.link :href="route('documentation.v1.interaction.toast')" text="Toast" />
                    </li>
                </ul>
            </li>
            <li class="relative ml-4">
    ...
    <li>
        ...
        <ul role="list" class="mt-4 space-y-2 dark:border-slate-800 lg:space-y-4 lg:mt-4 lg:border-slate-200">
            ...
            <li class="relative ml-4">
                <x-layout.navigation.link :href="route('documentation.v1.command')" text="Commands" new />
            </li>
            <li class="relative ml-4">
            ...
            <li class="relative ml-4">
                ...
                <ul role="list" class="mt-4 space-y-2 dark:border-slate-800 lg:space-y-4 lg:mt-4 lg:border-slate-200">
                    <li class="relative ml-4">
                        <x-layout.navigation.link :href="route('documentation.v1.dark-theme')" text="Dark Theme" />
                    </li>
                    <li class="relative ml-4">
                        <x-layout.navigation.link :href="route('documentation.v1.debug')" text="Debug Mode" />
                    </li>
                </ul>
            </li>
            <li class="relative ml-4">
