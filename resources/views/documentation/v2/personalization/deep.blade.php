...
<x-layout>
    ...
    <x-section title="Publishing Configuration File" disable-copy>
        <p>
            <a class="underline" href="{{ route('documentation.v1.configuration') }}" wire:navigate>To start deep personalization you must publish the TallStackUI configuration file.</a>
        </p>
    </x-section>
    <x-section title="Override Component Class" disable-copy>
        ...
        <x-warning>
            ...
            <a href="{{ route('documentation.v1.personalization.soft') }}" wire:navigate class="underline">soft personalization</a> can still be applied to components.
        </x-warning>
    </x-section>
    <x-section title="Override Component Colors" disable-copy>
        ...
        <p class="my-4">
            In this case the color personalization will only be applied for buttons <x-block>solid</x-block> with the color <x-block>primary</x-block>.
        </p>
    </x-section>
    <x-section title="Create Custom Colors" disable-copy>
        ...
        <p class="mt-2"><b>1.</b> Create the color in the TailwindCSS configuration file:</p>
        <x-code language="js" :contents="$prepareTailwindForCustomColor" />
        <p><b>2.</b> Create new indexes of your custom color name:</p>
        <x-code language="php" :contents="$applyingCustomColorsUsingDeepPersonalization" disable-copy />
        <p><b>3.</b> Use the component with the name of your custom color:</p>
